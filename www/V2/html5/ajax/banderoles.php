...
<div id="banderoles_config">
   ...
   <div class="container-right">
      ...
      <div id="block_right7">
         <a href="#" id="pdf_button">pdf</a>
         <a href="#" id="addpanier_button">Ajouter au panier</a>
         <a href="#" id="pdf_button_download" target="_blank" style="display: none;">Download PDF</a>
...
<script src="<?= $strUrlModuleHTML5 ?>js/html2canvas.svg.js"></script>
<script type="text/javascript"> 
   $("#pdf_button").click(function(e){
   	...
   	$(".elementContainer img.elemContent").each(function (index) {
   		...
   		if($(this).closest('.elementContainer').hasClass("typeText")){
            ...
            fontsize= $(this).closest('.elemContent').attr("fontsize");
   		}
   		else{
   			font= "0";
   			fontsize= "0";
   ...
   anglecurrent:anglecurrent
   	...
   	var heightplaque=$("#banderole_bg").css( "height" );
   	var widthplaque=$("#banderole_bg").css( "width" );
   	var toplaque=$("#banderole_bg").css( "top" );
   	var leftplaque=$("#banderole_bg").css( "left" );
        ...
        $.ajax({
        	...
        	success : function(result){
 	          if(result['file_stat'] === 1){
 	              var urlPdf = '<?php echo  "http://".$host . $strUrlModuleHTML5 ?>ajax'+result['pdf_path'];
                  console.log(urlPdf);
                  $("#pdf_button_download").attr("href", urlPdf);
                  $("#pdf_button_download").trigger( "click" );  
 	          }
        	},
        	error : function(data){ 
        		console.log(data);
