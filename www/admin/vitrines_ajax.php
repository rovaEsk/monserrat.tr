...
$scriptcourant = "vitrines.php";

if(isset($action) && $action == "add_regle_prix"){
	if($admin_droit[$scriptcourant][ecriture]){
	   /** insert regle des prix **/
        $DB_site->query("INSERT INTO prixarticlemodule (prixmodule, regleprix, categorieregleprixid) VALUES ('$new_prixmodulehtc', '$new_regle_prix', '$categorie_regle_prix')");
