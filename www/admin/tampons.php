...
$referencepage="tampons";
$pagetitle = "Gestion du module tampons - $host - Admin Arobases";

$titrepage=$multilangue[gestion_tampons];
$lienpagebase="tampons.php";
$niveaunavigsup="";

$class_menu_gestion_modules_tampons_active = "active";
...
if (!isset($action) or $action == ""){
    if($admin_droit[$scriptcourant][suppression]){
       ...
       header('location: tampons.php?erreurdroits=1'); 
    }	
}
/** edit form module **/
