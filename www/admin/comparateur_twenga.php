...
$nom_comparateur = "comparateur_twenga";
...
if (!function_exists("exporter_twenga")) {
	function exporter_twenga($siteid){	
		...
		$contenu = "brand|designation|price|regular_price|product_url|description|image_url|category|merchant_id|in_stock|shipping_cost\n";
		$where = "";
		...
		if (isset($provenance) and $provenance == "selection"){
			$nom_fic = "export_twenga_selection$siteid.txt";
			...
			$nom_fic = "export_twenga$siteid.txt";
...
if(!$onestdansuncron){
	...
	while($site = $DB_site->fetch_array($sites)){
		...
		$contenu = exporter_twenga($site[siteid]);
