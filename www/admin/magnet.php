...
$referencepage="magnet";
$pagetitle = "Gestion du module magnet - $host - Admin Arobases";

$titrepage=$multilangue[gestion_magnet];
$lienpagebase="magnet.php";
$niveaunavigsup="";

$class_menu_gestion_modules_magnet_active = "active";
...
if (!isset($action) or $action == ""){
    if($admin_droit[$scriptcourant][suppression]){
       ...
       header('location: magnet.php?erreurdroits=1'); 
    }	
}
/** edit form module **/
