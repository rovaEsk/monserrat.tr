...
$referencepage="lettrages_adhesifs";
$pagetitle = "Gestion du module lettrages_adhesifs - $host - Admin Arobases";

$titrepage=$multilangue[gestion_lettrages_adhesifs];
$lienpagebase="lettrages_adhesifs.php";
$niveaunavigsup="";

$class_menu_gestion_modules_lettrages_adhesifs_active = "active";
...
if (!isset($action) or $action == ""){
    if($admin_droit[$scriptcourant][suppression]){
       ...
       header('location: lettrages_adhesifs.php?erreurdroits=1'); 
    }	
}
/** edit form module **/
if(isset($action) && $action == "modifmodule"){
    ...
    if($admin_droit[$scriptcourant][ecriture]){
        ...
        header('location: lettrages_adhesifs.php');   
    }else{
        header('location: lettrages_adhesifs.php?erreurdroits=1');	
    }
}
