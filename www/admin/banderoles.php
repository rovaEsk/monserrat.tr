...
$referencepage="banderoles";
$pagetitle = "Gestion du module banderoles - $host - Admin Arobases";

$titrepage=$multilangue[gestion_banderoles];
$lienpagebase="banderoles.php";
$niveaunavigsup="";

$class_menu_gestion_modules_banderoles_active = "active";
...
if (!isset($action) or $action == ""){
    if($admin_droit[$scriptcourant][suppression]){
       ...
       header('location: banderoles.php?erreurdroits=1'); 
    }	
}
/** edit form module **/
if(isset($action) && $action == "modifmodule"){
    ...
    if($admin_droit[$scriptcourant][ecriture]){
        ...
        header('location: banderoles.php');   
    }else{
        header('location: banderoles.php?erreurdroits=1');	
    }
}
