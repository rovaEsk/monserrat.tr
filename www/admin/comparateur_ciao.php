...
$nom_comparateur = "comparateur_ciao";
...
if (!function_exists("exporter_ciao")) {
	function exporter_ciao($siteid){	
		...
		$liste_artid = "SELECT artid FROM article_comparateur WHERE comparateurid = '18' AND siteid = '$siteid' ORDER BY artid";
		$contenu="libelle;marque;ean;url;url image;prix TTC;frais port TTC;dispo;description;categorie;sku;id;currency\n";
...
if(!$onestdansuncron){
	...
	while($site = $DB_site->fetch_array($sites)){
		$provenance = "";
		$contenu=exporter_ciao($site[siteid]);
